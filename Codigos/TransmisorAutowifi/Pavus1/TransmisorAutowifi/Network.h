...
// -----------------------------------------------
#define   servername "pavus"  // Set your server's logical name here e.g. if 'myserver' then address is http://myserver.local/
...
const char ssid_1[]     = "Cuphead";
const char password_1[] = "79692352AZ+";
